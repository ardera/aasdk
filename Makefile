...
libaaproto.h: $(H_FILES)
	@cat $(H_FILES) > libaaproto.h
...
clean:
	@rm -rf $(C_FILES) $(H_FILES) $(O_FILES) libaaproto_unbundled.a libaaproto.a libaaproto.h
